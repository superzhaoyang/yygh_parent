...
import com.superzhaoyang.yygh.hosp.mapper.ScheduleMapper;
...
import com.superzhaoyang.yygh.model.hosp.BookingRule;
...
public class ScheduleServiceImpl extends ServiceImpl<ScheduleMapper, Schedule> implements ScheduleService {
    ...
    public Map<String, Object> getBookingScheduleRule(Integer page, Integer limit, String hoscode, String depcode) {
        ...
        for (int i = 0, len = dateList.size(); i < len; i++) {
            ...
            //当天预约如果过了停号时间， 不能预约
            if (i == 0 && page == 1) {
                DateTime stopTime = this.getDateTime(new Date(2021, 1, 5), bookingRule.getStopTime());
        ...
        //月
        baseMap.put("workDateString", new DateTime(2021, 1, 5,0,0).toString("yyyy年MM月"));
        //放号时间
    ...
    private IPage getListDate(Integer page, Integer limit, BookingRule bookingRule) {
        // 获取当天放号时间
        DateTime releaseTime = this.getDateTime(new Date(2021, 1, 5), bookingRule.getReleaseTime());
        // 获取预约周期
        ...
        for (int i = 0; i < cycle; i++) {
            //计算当前预约日期
            DateTime curDateTime = new DateTime(2021, 1, 5, 0, 0).plusDays(i);
